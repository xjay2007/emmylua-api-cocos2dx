...
---@return ccui.TabControl
function m:insertTab(index, header, container) end
...
---@return ccui.TabControl
function m:ignoreHeadersTextureSize(ignore) end

--- get tab header's width<br>
--- return header's width
---@return float
function m:getHeaderWidth() end

--- the header dock place of header in TabControl<br>
--- param dockPlace The strip place
---@param dockPlace int
---@return ccui.TabControl
function m:setHeaderDockPlace(dockPlace) end

---@overload fun(self:ccui.TabControl, index:ccui.TabHeader):ccui.TabControl
---@param index int
---@return ccui.TabControl
function m:setSelectTab(index) end

--- get TabHeader<br>
--- param index The index of tab
---@param index int
---@return ccui.TabHeader
function m:getTabHeader(index) end
...
---@return int
function m:indexOfTabHeader(tabCell) end

--- get Container<br>
--- param index The index of tab
---@param index int
---@return ccui.Layout
function m:getTabContainer(index) end

--- get the delta zoom of selected tab<br>
--- return zoom, the delta zoom
---@return float
function m:getHeaderSelectedZoom() end

--- get tab header's height<br>
--- return header's height
---@return int
function m:getHeaderHeight() end
