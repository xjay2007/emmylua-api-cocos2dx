...
---@param key string
---@return cc.TextureCache
function m:removeTextureForKey(key) end
...
---@return cc.TextureCache
function m:removeAllTextures() end
...
--- since v1.0
---@return string
function m:getCachedTextureInfo() end

---@overload fun(self:cc.TextureCache, image:string):cc.Texture2D
---@param image cc.Image
---@param key string
---@return cc.Texture2D
function m:addImage(image, key) end
...
---@param filename string
---@return cc.TextureCache
function m:unbindImageAsync(filename) end
...
---@param key string
---@return cc.Texture2D
function m:getTextureForKey(key) end
...
---@return string
function m:getTextureFilePath(texture) end
...
---@return cc.TextureCache
function m:renameTextureWithKey(srcName, dstName) end
...
--- since v0.8
---@return cc.TextureCache
function m:removeUnusedTextures() end

---  Deletes a texture from the cache given a texture.
---@param texture cc.Texture2D
---@return cc.TextureCache
function m:removeTexture(texture) end

--- Called by director, please do not called outside.
---@return cc.TextureCache
function m:waitForQuit() end

--- 
---@param suffix string
---@return cc.TextureCache
function m:setETC1AlphaFileSuffix(suffix) end

--- 
---@return string
function m:getETC1AlphaFileSuffix() end

--- js ctor
---@return cc.TextureCache
function m:TextureCache() end
