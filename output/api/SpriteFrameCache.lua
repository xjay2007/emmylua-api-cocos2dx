...
---@param plist string
---@return boolean
function m:reloadTexture(plist) end
...
function m:addSpriteFramesWithFileContent(plist_content, texture) end
...
---@return cc.SpriteFrameCache
function m:addSpriteFrame(frame, frameName) end

---@overload fun(self:cc.SpriteFrameCache, plist:string, texture:string):cc.SpriteFrameCache
---@overload fun(self:cc.SpriteFrameCache, plist:string):cc.SpriteFrameCache
---@param plist string
---@param texture cc.Texture2D
---@return cc.SpriteFrameCache
function m:addSpriteFramesWithFile(plist, texture) end
...
function m:getSpriteFrameByName(name) end
...
---@param plist string
---@return cc.SpriteFrameCache
function m:removeSpriteFramesFromFile(plist) end
...
---@return cc.SpriteFrameCache
function m:removeSpriteFrames() end
...
--- js NA
---@return cc.SpriteFrameCache
function m:removeUnusedSpriteFrames() end
...
---@param plist string
---@return boolean
function m:isSpriteFramesWithFileLoaded(plist) end
...
---@param texture cc.Texture2D
---@return cc.SpriteFrameCache
function m:removeSpriteFramesFromTexture(texture) end
