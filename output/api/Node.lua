...
---@overload fun(self:cc.Node, child:cc.Node, localZOrder:int):cc.Node
---@overload fun(self:cc.Node, child:cc.Node):cc.Node
---@overload fun(self:cc.Node, child:cc.Node, localZOrder:int, name:int):cc.Node
---@param child cc.Node
...
---@overload fun(self:cc.Node, name:cc.Component):boolean
---@param name string
---@return boolean
...
---@return cc.Node
function m:setPhysicsBody(physicsBody) end
...
---@return cc.Node
function m:setCascadeOpacityEnabled(cascadeOpacityEnabled) end
...
---@param callback fun
---@return cc.Node
function m:setOnExitCallback(callback) end
...
---@return cc.vec2
function m:convertToWorldSpaceAR(nodePoint) end
...
---@return boolean
function m:isIgnoreAnchorPointForPosition() end
...
---@param scaleZ float
---@return cc.Node
function m:setScaleZ(scaleZ) end
...
---@param callback fun
---@return cc.Node
function m:setonEnterTransitionDidFinishCallback(callback) end

--- Removes all components
---@return cc.Node
function m:removeAllComponents() end

--- 
---@param z int
---@return cc.Node
function m:_setLocalZOrder(z) end
...
---@param nodePoint cc.vec2
---@return cc.vec2
function m:convertToWorldSpace(nodePoint) end
...
---@param callback fun
---@return cc.Node
function m:setOnEnterCallback(callback) end
...
---@param flags uint
---@return cc.Node
function m:stopActionsByFlags(flags) end

--- 
---@param position cc.vec2
---@return cc.Node
function m:setNormalizedPosition(position) end

--- Set the callback of event ExitTransitionDidStart.<br>
--- param callback A std::function<void()> callback.
---@param callback fun
---@return cc.Node
function m:setonExitTransitionDidStartCallback(callback) end
...
---@return cc.vec2
function m:convertTouchToNodeSpace(touch) end
...
function m:getNodeToParentAffineTransform(ancestor) end

--- Whether cascadeOpacity is enabled or not.<br>
--- return A boolean value.
---@return boolean
function m:isCascadeOpacityEnabled() end
...
--- js NA
---@return cc.vec3
function m:getRotation3D() end

---@overload fun(self:cc.Node):mat4_table
---@param ancestor cc.Node
---@return mat4_table
function m:getNodeToParentTransform(ancestor) end
...
---@param touch cc.Touch
---@return cc.vec2
function m:convertTouchToNodeSpaceAR(touch) end
...
---@return cc.vec2
function m:convertToNodeSpace(worldPoint) end
...
---@param position cc.vec2
---@return cc.Node
function m:setPositionNormalized(position) end
...
---@overload fun(self:cc.Node, x:cc.vec2):cc.Node
---@param x float
---@param y float
---@return cc.Node
...
---@param tag int
---@return cc.Node
function m:stopActionByTag(tag) end
...
---@param localZOrder int
---@return cc.Node
function m:reorderChild(child, localZOrder) end
...
---@return cc.Node
function m:setNodeToParentTransform(transform) end
...
---@return int
function m:getNumberOfRunningActions() end
...
---@param worldPoint cc.vec2
---@return cc.vec2
function m:convertToNodeSpaceAR(worldPoint) end
...
---@param cleanup boolean
---@return cc.Node
function m:removeChildByName(name, cleanup) end
...
---@return cc.c3b
function m:getDisplayedColor() end
...
---@param tag int
---@return cc.Action
function m:getActionByTag(tag) end
...
--- 
---@return cc.AffineTransform
function m:getParentToNodeAffineTransform() end

---  Returns the normalized position.<br>
--- return The normalized position.
---@return cc.vec2
function m:getPositionNormalized() end
...
---@param cleanup boolean
---@return cc.Node
function m:removeChildByTag(tag, cleanup) end
...
--- 
---@return cc.AffineTransform
function m:getNodeToWorldAffineTransform() end
...
---@return mat4_table
function m:getParentToNodeTransform() end
...
---@param key string
---@return boolean
function m:isScheduled(key) end
...
---@overload fun(self:cc.Node, scaleX:float):cc.Node
---@param scaleX float
---@param scaleY float
---@return cc.Node
...
--- 
---@return cc.AffineTransform
function m:getWorldToNodeAffineTransform() end
...
---@return cc.Node
function m:setCascadeColorEnabled(cascadeColorEnabled) end
...
---@param tag int
---@return cc.Node
function m:stopAllActionsByTag(tag) end
...
---@return cc.Node
function m:setIgnoreAnchorPointForPosition(ignore) end
...
---@return float
function m:getGlobalZOrder() end
...
---@return cc.Node
function m:setUserObject(userObject) end

---@overload fun(self:cc.Node):cc.Node
---@param cleanup boolean
---@return cc.Node
function m:removeFromParentAndCleanup(cleanup) end
...
---@param tag int
---@return int
function m:getNumberOfRunningActionsByTag(tag) end
...
---@return cc.Node
function m:updateOrderOfArrival() end

--- 
---@return cc.vec2
function m:getNormalizedPosition() end
...
--- js getRotationX 
---@return float
function m:getRotationSkewX() end
...
--- js getRotationY
---@return float
function m:getRotationSkewY() end
...
---@return int
function m:getAttachedNodeCount() end
