...
function m:receiveExternalKeyEvent(externalKeyCode, receive) end
...
---@return cc.Controller
function m:startDiscoveryController() end

--- Stop the discovery process.<br>
--- warning The API has an empty implementation on Android.
---@return cc.Controller
function m:stopDiscoveryController() end
...
---@param deviceId int
---@return cc.Controller
function m:getControllerByDeviceId(deviceId) end
...
---@param tag int
---@return cc.Controller
function m:getControllerByTag(tag) end
