...
---@return cc.Action
function m:getActionByTag(tag, target) end
...
function m:removeActionByTag(tag, target) end
...
---@param target cc.Node
---@return cc.ActionManager
function m:removeActionsByFlags(flags, target) end

---  Removes all actions from all the targets.
---@return cc.ActionManager
function m:removeAllActions() end
...
---@return cc.ActionManager
function m:addAction(action, target, paused) end

---  Resumes the target. All queued actions will be resumed.<br>
--- param target    A certain target.
---@param target cc.Node
---@return cc.ActionManager
function m:resumeTarget(target) end
...
---@param target cc.Node
---@return cc.ActionManager
function m:pauseTarget(target) end
...
---@param target cc.Node
---@return int
function m:getNumberOfRunningActionsInTarget(target) end
...
---@param target cc.Node
---@return cc.ActionManager
function m:removeAllActionsByTag(tag, target) end
...
function m:getNumberOfRunningActionsInTargetByTag(target, tag) end

--- js ctor
---@return cc.ActionManager
function m:ActionManager() end
